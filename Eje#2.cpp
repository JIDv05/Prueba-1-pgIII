...
int main() {
    ...
    Usuario usuario("jose", "753951", "jd@unitec.edu");
    Administrador admin("root", "adminp", "admin@unitec.edu", "admin@ceutec.com");
    Cliente cliente("Andy Posas", "marco77", "ad@hotmail.com", "7845");
